...
if (wiriteFlag==0 && ((postPosition[2]/cm > -2650. && postPosition[2]/cm < -2550.&& abs(postPosition[0]/cm) < 117. && abs(postPosition[1]/cm) < 254.)||(postPosition[2]/cm > -3150. && postPosition[2]/cm < -3050.&& abs(postPosition[0]/cm) < 117. && abs(postPosition[1]/cm) < 254.)))
    {
      wiriteFlag = 1;
    }
