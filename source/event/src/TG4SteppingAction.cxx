...
if (wiriteFlag==0 && ((postPosition[2]/cm > -2650. && postPosition[2]/cm < -2550.&& abs(postPosition[0]/cm) < 60. && abs(postPosition[1]/cm) < 17-.)||(postPosition[2]/cm > -3150. && postPosition[2]/cm < -3050.&& abs(postPosition[0]/cm) < 60. && abs(postPosition[1]/cm) < 170.)))
    {
      wiriteFlag = 1;
    }
